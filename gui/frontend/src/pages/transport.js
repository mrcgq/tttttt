...
<div class="page-header" style="margin-bottom:20px">
  ...
  <p style="color:var(--c-text-2);font-size:13px">TLS 验证模式与传输协议配置</p>
</div>
...
<div class="card accent-blue">
  ...
  <div class="card-footer">
    <button class="btn btn-primary" onclick="TransportPage.saveVerify()">💾 保存</button>
  </div>
</div>
...
<div class="card">
  ...
  saveVerify() {
    App.state.tlsVerifyMode = document.getElementById('tls-verify')?.value || 'sni-skip';
    App.toast('TLS 验证模式已保存', 'success');
    App.log('info', 'TLS 验证: ' + App.state.tlsVerifyMode);
  },
