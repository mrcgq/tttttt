...
<div class="card accent-blue">
  ...
  <div class="card-footer">
    <button class="btn btn-primary" onclick="CadencePage.save()">💾 保存</button>
  </div>
</div>
...
<div class="card">
  <div class="card-header"><h3>↪️ 重定向</h3></div>
  <div class="card-body">
    <div class="toggle-row">
  ...
  <div class="card-footer">
    <button class="btn btn-primary" onclick="CadencePage.saveRedirect()">💾 保存</button>
  </div>
</div>`;
  },
  ...
  save() {
    ...
    App.log('info', '时序模式: ' + App.state.cadenceMode);
  },
